...
static CBlock LTC_CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
...
public:
    CMainParams() {
        ...
        genesis = LTC_CreateGenesisBlock(1317972665, 2084524493, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // std::cout << "-=-=-=-=--\n" << genesis.ToString() << "0-0-0-0-0-0-0\n";
